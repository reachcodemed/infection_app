...
class PaedsOtitisMedia extends StatefulWidget {
  @override
  _PaedsOtitisMediaState createState() => _PaedsOtitisMediaState();
}

class _PaedsOtitisMediaState extends State<PaedsOtitisMedia> {
