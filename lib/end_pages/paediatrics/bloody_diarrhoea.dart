...
class PaedsBloodyDiarrhoea extends StatefulWidget {
  @override
  _PaedsBloodyDiarrhoeaState createState() => _PaedsBloodyDiarrhoeaState();
}

class _PaedsBloodyDiarrhoeaState extends State<PaedsBloodyDiarrhoea> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ClassicEndPage(
        pageTitle: "Bloody Diarrhoea & Sepsis",
        ...
        toggleBox2: WeightOrHeightEntryPaeds(title: '2. Weight',
