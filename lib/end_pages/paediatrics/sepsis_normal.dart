...
class PaedsSepsisOlder extends StatefulWidget {
  @override
  _PaedsSepsisOlderState createState() => _PaedsSepsisOlderState();
}

class _PaedsSepsisOlderState extends State<PaedsSepsisOlder> {
    ...
    return Scaffold(
      ...
      body: ClassicEndPage(
        ...
        toggleBox4: YesNoToggleBasic(
          ...
          indexPosition: isUnderlyingDisease,
