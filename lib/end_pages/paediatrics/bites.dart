...
class PaedsBites extends StatefulWidget {
  @override
  _PaedsBitesState createState() => _PaedsBitesState();
}

class _PaedsBitesState extends State<PaedsBites> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ClassicEndPage(
        ...
        toggleBox1: AgeToggleSwitchPaeds(
            title: '1. Age',
            onChanged: (input)
            {
              inputAge = input;
