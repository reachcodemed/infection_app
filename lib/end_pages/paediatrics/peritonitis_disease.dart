...
class PaedsDiseasePeritonitis extends StatefulWidget {
  @override
  _PaedsDiseasePeritonitisState createState() => _PaedsDiseasePeritonitisState();
}

class _PaedsDiseasePeritonitisState extends State<PaedsDiseasePeritonitis> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ClassicEndPage(
        pageTitle: "Peritonitis GI Disease",
