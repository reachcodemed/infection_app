...
class SurgicalProphylaxis extends StatelessWidget {
  ...
  final List<Widget> surgicalProphylaxisTileNavigation= [OpeningPage(),CardiacSurgery(),EndocarditisProphylaxis(),GastrointestinalEndoscopy(),GynaecologyAndObstetrics(),LowerGISurgery(),OrthopaedicSurgery(),UpperGISurgery(),UrologySurgery(),VascularSurgery(),];
