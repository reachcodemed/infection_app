...
class AgeToggleSwitchPaeds extends StatefulWidget {
  AgeToggleSwitchPaeds({Key? key, required this.title, required this.indexPosition, this.isActive = true, this.upperBoxHeight = 0, this.switchColour = kHighlightedToggleRed, required this.onChanged, required this.onValueChanged}) : super(key: key);
...
class AmiOrGentCalculateScreen extends StatefulWidget {
  AmiOrGentCalculateScreen({Key? key,
    ...
    required this.fieldTextCreatinine}) : super(key: key);
  ...
  @override
  _AmiOrGentCalculateScreenState createState() => _AmiOrGentCalculateScreenState();
}
...
class _AmiOrGentCalculateScreenState extends State<AmiOrGentCalculateScreen> {
  ...
  Widget build(BuildContext context) {
    return DosingEndPage(
      ...
      antibioticTextOutput1: "Dose of Amikacin\n\nCreatinine Clearance\n\nIdeal Body Weight (IBW)",
      antibioticTextOutput2: '= ${widget.doseOutput}\n\n= ${widget.creatinineClearanceOutput}\n\n= ${widget.idealBodyWeightOutput}',
...
class BloodCulturesEndPage extends StatelessWidget {
  BloodCulturesEndPage({Key? key, required this.title, this.titleBoxColour = kResultsInterpretationPink, this.lowerTitle = 'Information', required this.selectionTitles, required this.onSelectedItemChanged, required this.notifyParent, this.subtitleBoxColour = kSurgicalLightOrange, this.firstTextArea, this.secondTextArea, this.thirdTextArea, this.extraWidget,}) : super(key: key);
...
class ClassicEndPage extends StatelessWidget {
  ClassicEndPage({
    ...
    this.widgetSpacing = 15,}) : super(key: key);
            ...
            CupertinoSlidingSegmentedControl<int>(
              ...
              children:
              {
                0:Container(
                  ...
                  constraints: BoxConstraints.expand(width: widget.minWidth, height: 30),
...
class DosingDoubleToggle extends StatefulWidget {
  DosingDoubleToggle({Key? key, required this.title, required this.indexPosition, required this.onValueChanged, this.isActive = true, this.upperBoxHeight = 0, this.switchColour = kHighlightedToggleRed, this.button1, this.button2, required this.firstToggleText, required this.secondToggleText}) : super(key: key);
                ...
                Row(
                  children: [
                    ...
                    CupertinoSlidingSegmentedControl<int>(
                      ...
                      children:
                      {
                        0:Text(widget.firstToggleText,
                        style: const TextStyle(
                          fontSize: 14,
                        ),),
                        1:Text(widget.secondToggleText,
                          style: const TextStyle(
                            fontSize: 14,
                          ),
                        ),
                  ...
                  Container(
                    child: Row(
                      children: [
                        ...
                        Padding(
                          padding: const EdgeInsets.fromLTRB(8,0,0,0),
                          child: Text(antibioticTextOutput2,
...
class DoubleSwitchFullWidth extends StatefulWidget {
  DoubleSwitchFullWidth({Key? key, required this.indexPosition, required this.onValueChanged, this.firstText = "First-Line", this.secondText = "Penicillin Allergy", this.switchColour = kHighlightedToggleYellow}) : super(key: key);
          ...
          builder: (context,constraints)=>
              CupertinoSlidingSegmentedControl<int>(
                ...
                children:
                {
                  0: Container(
                    alignment: Alignment.center,
                    constraints: BoxConstraints.expand(width: constraints.maxWidth/2.05, height: 30),
                    child: Text(widget.firstText,
                      textAlign: TextAlign.center,
                      style:const TextStyle(
                        fontSize: 13,
...
class MenuTile extends StatelessWidget {
  const MenuTile({  Key? key, this.tileTitle = '', this.leadingIcon, required this.navigateTo, this.leadingPadding = 0.0, this.minLeadingWidth = 0.0, this.tileColour = Colors.white, this.trailingIconColour = kIconLightGrey, this.titleTextColour = Colors.black, this.tileIsDense = true, this.iconSize = 0.0}): super(key: key);
...
class QuadSwtichFullWidth extends StatefulWidget {
  QuadSwtichFullWidth({Key? key, required this.indexPosition, required this.onValueChanged, required this.firstText, required this.secondText, required this.thirdText, required this.fourthText,this.switchColour = kHighlightedToggleYellow}) : super(key: key);
          ...
          builder: (context,constraints)=>
              CupertinoSlidingSegmentedControl<int>(
                ...
                children:
                {
                  0: Container(
                    alignment: Alignment.center,
                    constraints: BoxConstraints.expand(width: constraints.maxWidth/4.05, height: 30),
                    child: Text(widget.firstText,
                      textAlign: TextAlign.center,
                      style:const TextStyle(
                        fontSize: 13,
...
class TopColourBox extends StatelessWidget {
  const TopColourBox({Key? key, required this.boxColour, required this.boxText, this.trailingTopBoxIcon,}) : super(key: key);
...
class ToggleSwitchQuad extends StatefulWidget {
  ToggleSwitchQuad({Key? key, required this.title, required this.indexPosition, required this.onValueChanged,this.isActive = true, this.upperBoxHeight = 0, required this.firstText, required this.secondText, required this.thirdText, required this.fourthText, required this.switchColour, this.buttonSpecificFontSize1 = 15,this.buttonSpecificFontSize2 = 15,this.buttonSpecificFontSize3 = 15, this.minWidth = 35}) : super(key: key);
...
class ToggleSwitchTriple extends StatefulWidget {
  ToggleSwitchTriple({Key? key, required this.title, required this.indexPosition, required this.onValueChanged,this.isActive = true, this.upperBoxHeight = 0, required this.firstText, required this.secondText, required this.thirdText, required this.switchColour, this.buttonSpecificFontSize1 = 15,this.buttonSpecificFontSize2 = 15,this.buttonSpecificFontSize3 = 15, this.minWidth = 60}) : super(key: key);
...
class TripleSwitchFullWidth extends StatefulWidget {
  TripleSwitchFullWidth({Key? key, required this.indexPosition, required this.onValueChanged, this.firstText = "First-Line", this.secondText = "Penicillin Allergy", this.thirdText = "MRSA positive", this.switchColour = kHighlightedToggleYellow, this.isActive = true, this.minSpacerHeight = 10,}) : super(key: key);
          ...
          builder: (context,constraints)=>
              CupertinoSlidingSegmentedControl(
                  ...
                  children:
                    ...
                    0: Container(
                            alignment: Alignment.center,
                            constraints: BoxConstraints.expand(width: constraints.maxWidth/3.05, height: 30),
                            child: Text(widget.firstText,
                            style:const TextStyle(
                              fontSize: 13,
                            ),
...
class TopRedInfoBox extends StatelessWidget {
  TopRedInfoBox({
    Key? key, this.height = 100.0, this.textInput = '', this.textAlignment = Alignment.center, this.verticalPadding = 10, this.horizontalPadding = 25, this.boxColour = kTextBoxRed
  }) : super(key: key);
...
class PenicillinToggle extends StatefulWidget {
  PenicillinToggle({Key? key, required this.isPenicillinAllergic, required this.notifyParent, required this.isSelected, this.boxColour = kTextBoxRed, this.switchColour = kHighlightedToggleRed, this.titleText = "Penicillin", this.firstText = "Anaphylaxis", this.secondText = "Rash",this.bottomHeight = 0}) : super(key: key);
          ...
          children: [
            ...
            Container(
              ...
              child: ToggleButtons(
                ...
                onPressed: widget.isPenicillinAllergic?(int index)
                {
...
class PenicillinSlider extends StatefulWidget {
  PenicillinSlider({Key? key, required this.indexPosition, this.boxColour = kTextBoxRed, this.switchColour = kHighlightedToggleRed, this.titleText = "Penicillin", this.firstText = "Anaphylaxis", this.secondText = "Rash",this.bottomHeight = 0, required this.onValueChanged}) : super(key: key);
...
class ResultsInterpretationEndPage extends StatelessWidget {
  const ResultsInterpretationEndPage({Key? key,
    required this.pageTitle,
    this.topPanelColour = kResultsInterpretationPink,
    this.titleTextColour = Colors.white,
    this.topRedBox,
...
class SpectraColoringTile extends StatelessWidget {
  SpectraColoringTile({
    Key? key, required this.title, required this.tileColour, required this.variableColour, this.fontWeight = FontWeight.w400, this.flex = 3, this.customTextColour = Colors.black,
  }) : super(key: key);
...
class SubBarAndText extends StatelessWidget {
  const SubBarAndText({
    Key? key,
    required this.lowerTitle, required this.outputText, required this.barColour
  }) : super(key: key);
...
class SubMenuModule extends StatelessWidget {
  const SubMenuModule({Key? key, required this.tileTitles, required this.tileNavigation, required this.topBoxColour, required this.topBoxText, this.tileLeadingIcon, this.topBoxTrailingIcon, this.leadingPadding = 20.0, this.iconSize = 0.0}) : super(key: key);
...
class SurgicalProphylaxisEndPage extends StatefulWidget {
  ...
  @override
  State<SurgicalProphylaxisEndPage> createState() => _SurgicalProphylaxisEndPageState();
}

class _SurgicalProphylaxisEndPageState extends State<SurgicalProphylaxisEndPage> {
...
class WeightOrHeightEntryPaeds extends StatefulWidget {
  WeightOrHeightEntryPaeds({Key? key, required this.title, this.upperBoxHeight = 0, this.switchColour = kHighlightedToggleRed, required this.onChanged, this.units = 'kg', required this.fieldText}) : super(key: key);
  ...
  @override
  _WeightOrHeightEntryPaedsState createState() => _WeightOrHeightEntryPaedsState();
}
...
class YesNoToggleBasic extends StatefulWidget {
  YesNoToggleBasic({Key? key, required this.title, required this.indexPosition,this.isActive = true, this.upperBoxHeight = 0, this.switchColour = kHighlightedToggleRed,required this.onValueChanged}) : super(key: key);
...
class YesNoToggleSwitchBasic extends StatefulWidget {
  YesNoToggleSwitchBasic({Key? key, required this.title, required this.indexPosition, required this.notifyParent,this.isActive = true, this.upperBoxHeight = 0, this.switchColour = kHighlightedToggleRed,}) : super(key: key);
            ...
            Container(
              ...
              ToggleButtons(
                ...
                onPressed: widget.isActive?(int index)
                {
                  ...
                  setState(() {
                    for (int buttonIndex = 0; buttonIndex < widget.indexPosition.length; buttonIndex++) {
                      if (buttonIndex == index) {
...
class YesNoToggleSwitchScoring extends StatefulWidget {
  YesNoToggleSwitchScoring({Key? key, required this.title, required this.indexPosition, this.upperBoxHeight = 0, required this.onValueChanged, this.switchColour = kHighlightedToggleYellow}) : super(key: key);
  ...
  @override
  _YesNoToggleSwitchScoringState createState() => _YesNoToggleSwitchScoringState();
}
